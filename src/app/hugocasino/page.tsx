...
const casino = casinos.find((c) => c.slug === "hugocasino");

export default function HugoCasinoPage() {
  if (!casino) notFound();
  ...
  const bonuses = [
    {
      ...
      desc: "100% έως €150 + 100 Δωρεάν Περιστροφές στην πρώτη κατάθεση",
      minDep: "€20",
      wager: "45x (μπόνους + κατάθεση)",
      limit: "Μέγιστο ποντάρισμα €5 ανά γύρο",
    },
    {
      type: "Μπόνους 2ης Κατάθεσης",
      desc: "75% έως €150 + 75 Δωρεάν Περιστροφές",
      minDep: "€20",
      wager: "45x (μπόνους + κατάθεση)",
      limit: "Μέγιστο ποντάρισμα €5 ανά γύρο",
    },
    {
      ...
      desc: "50% έως €300 + 100 Δωρεάν Περιστροφές",
      minDep: "€20",
      wager: "45x (μπόνους + κατάθεση)",
      limit: "Μέγιστο ποντάρισμα €5 ανά γύρο",
    },
    {
      ...
      desc: "50% έως €500 + 200 Δωρεάν Περιστροφές για καταθέσεις άνω των €500",
      minDep: "€500",
      wager: "45x (μπόνους + κατάθεση)",
  ...
  const popularGames = [
    { name: "Nine to Five", img: "nine-to-five" },
    { name: "Chaos Crew II", img: "chaos-crew-ii" },
    { name: "Hand of Anubis", img: "hand-of-anubis" },
    { name: "Sky Bounty", img: "sky-bounty" },
    { name: "GladiaToro", img: "gladiatoro" },
  ];
  ...
  const transactionLimits = [
    ...
    },
    {
      ...
      value: "€500/ημέρα • €6.000/μήνα (νέοι παίκτες)\n€15.000/μήνα (VIP)",
      icon: ArrowDownCircle,
    },
    {
      title: "Χρόνος Ανάληψης",
      value: "Έως 24 ώρες για επαληθευμένους λογαριασμούς",
      icon: CalendarClock,
    },
  ];
  ...
  const prosCons = [
    {
      type: "pro",
      text: "Μεγάλη ποικιλία παιχνιδιών (4.000+ τίτλοι)",
    },
    {
      type: "con",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Ανακαλύψτε το ${name} στο MystikoPaixnidi.gr: μπόνους καλωσορίσματος, δωρεάν περιστροφές, ${rating} αστέρια και υποστήριξη κρυπτονομισμάτων.`}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mystikopaixnidi.gr/hugocasino" />
        ...
        <meta
          ...
          content={`Παίξτε στο ${name} Casino με 100% έως €150 + 100 Δωρεάν Περιστροφές και VIP offers.`}
        />
        <meta
          property="og:url"
          content="https://mystikopaixnidi.gr/hugocasino"
        />
          ...
          <section className="py-0 bg-white">
            <div className="max-w-5xl mx-auto p-4">
              <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
                Το <span className="font-semibold">Hugo Casino</span> ιδρύθηκε
                το 2023 και λειτουργεί υπό την άδεια της{" "}
                <span className="font-medium">
                  Curacao eGaming (Άρ. Άδειας: 8048/JAZ2020-074)
                </span>
                . Ανήκει στην εταιρεία{" "}
                <span className="font-medium">GBL Solutions N.V.</span> και
            ...
            <div className="container mx-auto px-6 lg:px-20">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                  Πάνω από <span className="font-semibold">4.000 τίτλοι</span>,{" "}
                  κουλοχέρηδες, επιτραπέζια και ζωντανό καζίνο
                </p>
              </div>
              <div className="mb-16">
