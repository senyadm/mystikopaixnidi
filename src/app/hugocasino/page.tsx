        ...
        <section className="py-0 bg-white">
          <div className="max-w-5xl mx-auto p-4">
            <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
              Το <span className="font-semibold">Hugo Casino</span> ιδρύθηκε το 2023
              και λειτουργεί υπό την άδεια της{" "}
              <span className="font-medium">
                Curacao eGaming (Άρ. Άδειας: 8048/JAZ2020-074)
              </span>
              . Ανήκει στην εταιρεία{" "}
              <span className="font-medium">GBL Solutions N.V.</span> και προσφέρει
              μια ευρεία γκάμα παιχνιδιών, ελκυστικά μπόνους και ευέλικτες επιλογές
              πληρωμής, συμπεριλαμβανομένων των κρυπτονομισμάτων. Η πλατφόρμα είναι
              πλήρως βελτιστοποιημένη για κινητά, επιτρέποντας στους παίκτες να
              απολαμβάνουν τα αγαπημένα τους παιχνίδια εν κινήσει.
            </p>
          </div>
        </section>
