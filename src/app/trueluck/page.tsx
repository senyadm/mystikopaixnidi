...
export default function TrueLuckPage() {
  ...
  const prosCons = [
    {
      type: "pro",
      text: "Ελκυστικά μπόνους καλωσορίσματος και high roller προσφορές",
    },
    ...
    {
      type: "con",
      text: "Δεν διαθέτει native mobile app (μόνο browser-based)",
    },
  ];
          ...
          <section className="py-0 bg-white">
            <div className="max-w-5xl mx-auto p-4">
              <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
                Το <span className="font-semibold">TrueLuck Casino</span>{" "}
                ξεκίνησε τη λειτουργία του το 2025, ανήκει στην εταιρεία{" "}
                <span className="font-medium">
                  SOCIEDAD DE RESPONSABILIDAD LIMITADA
                </span>{" "}
                και λειτουργεί με άδεια από την κυβέρνηση της Κόστα Ρίκα. Η
                πλατφόρμα προσφέρει μια ευρεία γκάμα παιχνιδιών, ελκυστικά
                μπόνους και ευέλικτες επιλογές πληρωμής, συμπεριλαμβανομένων των
                κρυπτονομισμάτων.
              </p>
            </div>
          </section>
