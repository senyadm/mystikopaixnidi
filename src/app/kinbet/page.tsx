  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Ανακαλύψτε το ${name} Casino στο MystikoPaixnidi.gr: ${bonuses[0].desc}, αθλητικό στοίχημα, cashback & live παιχνίδια. Rating: ${rating}/5.`}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mystikopaixnidi.gr/kinbet" />
        ...
        <meta
          ...
          content={`Παίξτε στο ${name} Casino: ${bonuses[0].desc}, 100% έως €100 σε αθλητικό στοίχημα και 15% cashback για VIP.`}
        />
        <meta property="og:url" content="https://mystikopaixnidi.gr/kinbet" />
    ...
    h4.18a1 1 0 00.95-.69l1.286-3.97z"
          ...
          <section className="container mx-auto px-6 lg:px-20">
            <p className="text-gray-800 leading-relaxed text-xl">
              Το <span className="font-semibold">{name} Casino</span> ιδρύθηκε
              ...
              συναλλαγές με κάρτες, ηλεκτρονικά πορτοφόλια και κρυπτονομίσματα,
              με 24/7 υποστήριξη σε πολλαπλές γλώσσες, συμπεριλαμβανομένων των
              Ελληνικών.
            </p>
          </section>
