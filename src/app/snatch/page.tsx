...
const casino = casinos.find((c) => c.slug === "snatch");

export default function SnatchCasinoPage() {
  if (!casino) notFound();
  ...
  const bonuses = [
    {
      ...
      desc: "450% έως €6.000 + 325 Δωρεάν Περιστροφές σε 4 καταθέσεις",
      minDep: "€10",
    ...
    },
    {
      ...
      desc: "200% έως €1.000 + 100 Δωρεάν Περιστροφές στην πρώτη κατάθεση",
      minDep: "€30",
      wager: "35x (μπόνους + κατάθεση)",
      limit: "Διαθέσιμο μόνο για υψηλούς παίκτες",
    },
    {
      type: "Μπόνους Χωρίς Κατάθεση",
      desc: "30 Δωρεάν Περιστροφές στο παιχνίδι \"Sugar Rush\" με εγγραφή",
      minDep: "-",
      wager: "35x (κέρδη από περιστροφές)",
      limit: "Μέγιστο κέρδος €100",
    },
  ];
  ...
  const transactionLimits = [
    ...
    },
    {
      ...
      value: "€500 ανά συναλλαγή / €1.500 ανά 24 ώρες / €25.000 ανά μήνα",
      icon: ArrowDownCircle,
    },
    {
      title: "Χρόνος Ανάληψης",
      value: "Έως 24 ώρες (Δευτέρα - Παρασκευή, 09:00 - 18:00 GMT+3)",
      icon: CalendarClock,
    },
  ];
  ...
  const prosCons = [
    { type: "pro", text: "Μεγάλη ποικιλία παιχνιδιών (7.000+ τίτλοι)" },
    {
      type: "con",
      text: "Άδεια από την Curacao, λιγότερο αυστηρή από ευρωπαϊκές ρυθμιστικές αρχές",
    },
    ...
    <section className="container mx-auto px-4 py-8">
      <div className="bg-white text-gray-900 rounded-2xl shadow p-8">
        ...
        <section className="py-0 bg-white">
          <div className="max-w-5xl mx-auto p-4">
            <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
              Το <span className="font-semibold">Snatch Casino</span> ιδρύθηκε το 2021
              και λειτουργεί υπό την άδεια της <span className="font-medium">
              Curacao Gaming Control Board (8048/JAZ2021-049)
              </span>. Ανήκει στην εταιρεία <span className="font-medium">
              Altacore N.V.
              </span> και προσφέρει πάνω από <span className="font-semibold">
              7.000 παιχνίδια
              </span>, συμπεριλαμβανομένων κουλοχέρηδων, επιτραπέζιων παιχνιδιών, ζωντανού καζίνο και αθλητικού στοιχήματος. Οι παίκτες απολαμβάνουν ασφαλείς συναλλαγές μέσω καρτών, ηλεκτρονικών πορτοφολιών και κρυπτονομισμάτων, με υποστήριξη πελατών 24/7 σε πολλές γλώσσες, συμπεριλαμβανομένων των Ελληνικών.
            </p>
          </div>
        </section>
            ...
            <table className="min-w-full text-md text-left">
              <thead className="bg-[#5f99b8] text-white">
                <tr>
                  ...
                  <th className="px-6 py-3 font-medium">Απαίτηση Στοιχηματισμού</th>
              ...
              <tbody>
                {bonuses.map((b, idx) => (
                  <tr
                    key={b.type}
                    className={idx % 2 === 0 ? "bg-white hover:bg-[#5f99b8]/10" : "bg-gray-50 hover:bg-[#5f99b8]/10"}
                  >
        ...
        <section
          ...
          style={{ background: "linear-gradient(135deg, #5f99b8 0%, #4a85a2 100%)" }}
        >
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-extrabold text-white mb-4">🎮 Παιχνίδια και Πάροχοι</h2>
              <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                Πάνω από <span className="font-semibold">7.000 τίτλοι</span>, συμπεριλαμβανομένων κουλοχέρηδων, επιτραπέζιων παιχνιδιών, ζωντανού καζίνο και αθλητικού στοιχήματος
              </p>
            </div>
            <div className="mb-16">
              <h3 className="text-2xl font-bold text-white mb-6">Δημοφιλή Παιχνίδια</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
                {popularGames.map((game) => (
                  <div key={game.img} className="flex flex-col h-full bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    <div className="relative w-full h-48">
                      <Image src={`/games/${game.img}.png`} alt={game.name} layout="fill" objectFit="cover" />
                    </div>
                    <div className="p-5 flex-1 flex items-center justify-center">
                      <span className="font-semibold text-gray-700 text-lg text-center">{game.name}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">Πάροχοι Λογισμικού</h3>
              <div className="flex flex-wrap gap-4">
                {providers.map((provider) => (
                  <span key={provider} className="bg-white text-gray-700 px-5 py-2 rounded-full shadow-md whitespace-nowrap">
                    {provider}
                  </span>
                ))}
              </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-extrabold text-gray-800">💳 Μέθοδοι Πληρωμής</h2>
            </div>
              ...
              <table className="min-w-full bg-white rounded-xl shadow-md">
                ...
                <tbody>
                  {paymentMethods.map((m) => (
                    <tr key={m.img} className="border-b last:border-none hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 flex items-center">
                        <Image src={`/payments/${m.img}.png`} alt={m.name} width={32} height={32} className="mr-4" />
                        <span className="font-medium text-gray-700">{m.name}</span>
                      </td>
                      <td className="py-4 px-6 text-center">
                        {m.deposit ? <span className="text-green-500 text-xl">✓</span> : <span className="text-red-500 text-xl">✗</span>}
                      </td>
                      <td className="py-4 px-6 text-center">
                        {m.withdraw ? <span className="text-green-500 text-xl">✓</span> : <span className="text-red-500 text-xl">✗</span>}
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-extrabold text-gray-800">📈 Όρια και Χρόνοι Συναλλαγών</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              {transactionLimits.map(({ title, value, icon: Icon }) => (
                <div key={title} className="flex flex-col items-center bg-gray-50 rounded-lg shadow-md p-6 text-center">
                  <Icon className="w-12 h-12 text-blue-500 mb-4" />
                  <h3 className="text-lg font-medium text-gray-800 mb-2 whitespace-pre-line">{title}</h3>
                  <p className="text-xl font-bold text-gray-900 whitespace-pre-line">{value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section
          ...
          style={{ background: "linear-gradient(135deg, #f0f4f8 0%, #5f99b8 100%)" }}
        >
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-extrabold text-gray-800 mb-4">📞 Υποστήριξη Πελατών</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {supportChannels.map(({ name, icon: Icon, info }) => (
                <div key={name} className="flex flex-col items-center bg-white rounded-xl shadow-lg p-6 hover:scale-105 transition-transform duration-300">
        ...
        <section className="py-16 bg-gradient-to-r from-green-50 to-red-50 rounded-3xl">
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Μια συνοπτική επισκόπηση των δυνατών σημείων και των περιορισμών της πλατφόρμας.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {prosCons.map(({ type, text }) => {
                const Icon = type === "pro" ? CheckCircle : XCircle;
                const color = type === "pro" ? "text-green-500" : "text-red-500";
                return (
                  <div key={text} className="flex items-start bg-white rounded-lg shadow-md p-6 transform transition-transform duration-300 hover:scale-105">
