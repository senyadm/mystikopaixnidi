          ...
          <section className="py-0 bg-white">
            <div className="max-w-5xl mx-auto p-4">
              <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
                Το <span className="font-semibold">Snatch Casino</span> ιδρύθηκε
                το 2021 και λειτουργεί υπό την άδεια της{" "}
                <span className="font-medium">
                  Curacao Gaming Control Board (8048/JAZ2021-049)
                </span>
                . Ανήκει στην εταιρεία{" "}
                <span className="font-medium">Altacore N.V.</span> και προσφέρει
                πάνω από <span className="font-semibold">7.000 παιχνίδια</span>,
                συμπεριλαμβανομένων κουλοχέρηδων, επιτραπέζιων παιχνιδιών,
                ζωντανού καζίνο και αθλητικού στοιχήματος. Οι παίκτες
                απολαμβάνουν ασφαλείς συναλλαγές μέσω καρτών, ηλεκτρονικών
                πορτοφολιών και κρυπτονομισμάτων, με υποστήριξη πελατών 24/7 σε
                πολλές γλώσσες, συμπεριλαμβανομένων των Ελληνικών.
              </p>
            </div>
          </section>
