...
const casino = casinos.find((c) => c.slug === "royalgame");
...
export default function RoyalgamePage() {
  ...
  const transactionLimits = [
    ...
    },
    {
      ...
      value: "€10.500/ημέρα €30.000/μήνα",
  ...
  const prosCons = [
    ...
    {
      type: "pro",
      text: "Μεγάλη ποικιλία παιχνιδιών (9.000+ τίτλοι)",
    },
    {
      type: "pro",
        ...
        <section className="py-0 bg-white">
          <div className="max-w-5xl mx-auto p-4">
            <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
              Το <span className="font-semibold">RoyalGame Casino</span> ιδρύθηκε
              το 2024 και λειτουργεί με άδεια από την{" "}
              <span className="font-medium">Curacao eGaming</span>. Ανήκει στην
              εταιρεία <span className="font-medium">Rabidi N.V.</span>, η οποία
              διαχειρίζεται και άλλα γνωστά καζίνο. Η πλατφόρμα προσφέρει πάνω
              από <span className="font-semibold">9.000 παιχνίδια</span>,
              ...
              ηλεκτρονικά πορτοφόλια και κρυπτονομίσματα.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 lg:px-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                Πάνω από <span className="font-semibold">9.000 τίτλοι</span>, συμπεριλαμβανομένων κουλοχέρηδων, επιτραπέζιων παιχνιδιών, ζωντανού καζίνο και αθλητικού στοιχήματος
              </p>
            </div>
              ...
              <table className="min-w-full bg-white rounded-xl shadow-md">
                ...
                <tbody>
                  {paymentMethods.map((method) => (
                    <tr key={method.img} className="border-b last:border-none hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-6 text-center">
                        {method.deposit ? <span className="text-green-500 text-xl">✓</span> : <span className="text-red-500 text-xl">✗</span>}
                      </td>
                      <td className="py-4 px-6 text-center">
                        {method.withdraw ? <span className="text-green-500 text-xl">✓</span> : <span className="text-red-500 text-xl">✗</span>}
                      </td>
                    </tr>
                  ))}
                </tbody>
