  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Ανακαλύψτε το ${name} Casino στο MystikoPaixnidi.gr: 100% έως €500 + 200 Δωρεάν Περιστροφές, αθλητικό στοίχημα, VIP cashback, rating: ${rating}/5.`}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mystikopaixnidi.gr/royalgame" />
        ...
        <meta
          ...
          content={`Παίξτε στο ${name} Casino: 100% έως €500 + 200 Δωρεάν Περιστροφές, μπόνους 2ης κατάθεσης και VIP offers.`}
        />
        <meta
          property="og:url"
          content="https://mystikopaixnidi.gr/royalgame"
        />
          ...
          <section className="py-0 bg-white">
            <div className="max-w-5xl mx-auto p-4">
              <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
                Το <span className="font-semibold">RoyalGame Casino</span>{" "}
                ιδρύθηκε το 2024 και λειτουργεί με άδεια από την{" "}
                <span className="font-medium">Curacao eGaming</span>. Ανήκει
                στην εταιρεία <span className="font-medium">Rabidi N.V.</span>,
                η οποία διαχειρίζεται και άλλα γνωστά καζίνο. Η πλατφόρμα
                προσφέρει πάνω από{" "}
                <span className="font-semibold">9.000 παιχνίδια</span>,
            ...
            <div className="container mx-auto px-6 lg:px-20">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                  Πάνω από <span className="font-semibold">9.000 τίτλοι</span>,
                  συμπεριλαμβανομένων κουλοχέρηδων, επιτραπέζιων παιχνιδιών,
