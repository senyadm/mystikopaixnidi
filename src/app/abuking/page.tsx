        ...
        <section className="py-0 bg-white">
          <div className="max-w-5xl mx-auto p-4">
            <p className="text-gray-800 leading-relaxed text-center text-xl tracking-wide">
              Το <span className="font-semibold">AbuKing Casino</span> ιδρύθηκε
              το 2025 και λειτουργεί με άδεια από την{" "}
              <span className="font-medium">Anjouan Gaming Authority</span> (Αρ.
              Άδειας: ALSI-152406028-FI2). Ανήκει στην εταιρεία{" "}
              ...
              πλατφόρμα είναι πλήρως βελτιστοποιημένη για κινητά, επιτρέποντας στους παίκτες να
