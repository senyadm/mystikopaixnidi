...
export default function CasinovaPage() {
  ...
  const transactionLimits = [
    ...
    { title: "Ελάχιστη Ανάληψη", value: "€10", icon: ArrowUpCircle },
    {
      ...
      value:
        "€7.000 ανά μήνα (επίπεδο VIP 1), έως €20.000 ανά μήνα (επίπεδο VIP 5)",
  ...
  return (
    <>
      <Head>
        <title>
          MystikoPaixnidi.gr | ${name} Casino – Κορυφαίο Online Καζίνο
        </title>
        <meta
          name="description"
          content={`Ανακαλύψτε το ${name} Casino στο MystikoPaixnidi.gr: ελκυστικά μπόνους, ${rating} αστέρια, κρυπτονομίσματα και 24/7 υποστήριξη.`}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://mystikopaixnidi.gr/casinova`} />
        ...
        <meta
          ...
          content={`Παίξτε στο ${name} Casino με μπόνους έως 2.000€, δωρεάν περιστροφές και VIP rewards.`}
        />
        <meta property="og:url" content="https://mystikopaixnidi.gr/casinova" />
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="bg-white text-gray-900 rounded-2xl shadow p-8">
          ...
          <section className="py-0 bg-white mb-12">
            <div className="max-w-5xl mx-auto p-4 text-center">
              <p className="text-gray-800 leading-relaxed text-xl tracking-wide">
                Το <span className="font-semibold">Casinova Casino</span>{" "}
                ...
                <span className="font-medium">KNG Marketing Ltd</span> και
                προσφέρει μια ευρεία γκάμα παιχνιδιών, ελκυστικά μπόνους και
                ευέλικτες επιλογές πληρωμής, συμπεριλαμβανομένων των
                κρυπτονομισμάτων. Η πλατφόρμα είναι πλήρως βελτιστοποιημένη για
                κινητά, επιτρέποντας στους παίκτες να απολαμβάνουν τα αγαπημένα
                τους παιχνίδια εν κινήσει.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-4xl font-semibold mb-6 text-center text-gray-800 flex items-center justify-center gap-2">
          ...
          >
            <div className="container mx-auto px-6 lg:px-20 text-white">
              ...
              <p className="text-lg max-w-2xl mx-auto text-blue-100 text-center mb-12">
                Πάνω από <span className="font-semibold">9.200 τίτλοι</span>,
