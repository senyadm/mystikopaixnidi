        ...
        >
          <div className="container mx-auto px-6 lg:px-20 text-center text-white">
            ...
            <p className="text-lg mb-12">
              Πάνω από <span className="font-semibold">12.500 τίτλους</span>, με
              φίλτρα για εύκολη πλοήγηση.
            </p>
        ...
        >
          <div className="container mx-auto px-6 lg:px-20 text-center">
            ...
            <p className="text-gray-600 mb-12">
              24/7 live chat & email, με γρήγορη και επαγγελματική ανταπόκριση.
              VIP υποστήριξη διαθέσιμη.
            </p>
